# I'm Bryan Antier
![Aspiring Software Engineer](https://capsule-render.vercel.app/api?type=transparent&height=80&text=Aspiring%20Software%20Engineer&fontSize=32&fontColor=3B82F6)
## About me
...
$about_me = [
  ...
  'interest' => ['Software Development', 'DevOps', 'Automation'],
  'currentlyLearning' => ['DevOps', 'Laravel', '.Net', 'Cloud Technologies', 'System Design'],
  'status' => 'Open to work'
]
```
## Tech Stack
